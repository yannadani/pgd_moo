...
def run(config: dict):
    ...
    hv_pf_ideal = hv(nadir_point, res_y_pf_ideal, config["task"])
    ...
    print(f"Hypervolume Pareto Frontier (Ideal): {hv_pf_ideal:4f}")
...
if __name__ == "__main__":
    ...
    save_dir = "/p/project/obdifflearn/yashas/offline-moo/"
